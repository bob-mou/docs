> [!IMPORTANT]
>
> 一切未知的地方都存在风险                             一切和需求不符合的都是BUG                      破坏性测试思维
...
![文字云3D_wenziyun.cn_ (1)](README.assets/%E6%96%87%E5%AD%97%E4%BA%913D_wenziyun.cn_%20(1).png)

功能 冒烟 随机 黑盒 全量 白盒 灰盒 回归 验收 探索 压力 性能 兼容性 边界条件 逆向
