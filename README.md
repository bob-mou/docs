...
面试官你好，我叫牟连波，毕业于中南民族大学信息管理与信息系统专业，目前有近2年的游戏测试与开发相关经验。

**我曾就职于广州米茄科技有限公司**，担任测试工程师，参与过《交错战线》、《星陨》这两个**项目**。这两个项目都属于、二次元机甲美少女题材的放置类手游，第一个项目我负责模块背包、商城、角色技能、副本系统、好友、活动等，《星陨》负责了背包、好友、商城、任务和活动。**在项目中，我主要工作内容是**，参加需求评审，测试用例设计、编写用例、主持需求评审，执行测试，汇总BUG，跟踪BUG，我也做过性能优化测试（如使用PerfDog监控性能指标）、弱网络环境模拟验证，并全程跟踪BUG修复。**测试工具方面**，我熟悉Jira（用例和BUG管理平台）、ADB，之前做过一段时间网页开发，也懂得一些MYSQL，linux的命令工具。

个人热爱游戏行业，也比较看好这个行业，希望未来能够在游戏测试这个行业发展。面试官你好，我的介绍就是这样，谢谢。
