...
面试官你好，我叫牟连波，毕业于中南民族大学信息管理与信息系统专业，目前有近三年的游戏测试与开发相关经验。

我曾就职于广州米茄科技有限公司，担任测试工程师，参与过《星陨》《交错战线》等二次元科幻题材手游的测试工作，负责模块包括角色技能、副本系统、商城交互等。在项目中，我主导测试用例设计、性能优化测试（如使用PerfDog监控性能指标）、弱网络环境模拟验证，并全程跟踪BUG修复，确保游戏体验的流畅性。此外，我熟悉Jira、ADB、MYSQL等工具，擅长通过逻辑分析定位问题，并能从玩家视角提出优化建议。

在此之前，我在武汉零感网御担任Java兼职测试工程师，参与过设备管理运维系统的开发与测试，积累了需求分析、接口设计以及全流程测试的经验。

个人热爱游戏行业，熟悉端游与手游的多种类型，如《金铲铲》《原神》等，对游戏机制和玩家需求有深刻理解，甚至在日常游戏中主动挖掘并提交过BUG。我的优势是责任心强、思维缜密，擅长团队协作与高效沟通，同时具备较强的抗压能力。
...
4.3、性能是怎么测试（流程、工具），关注哪些指标？指标标准是怎么样的？你们当时的高、中、低机型用的是什么设备（明确说出来）？你们测试过程中有遇见哪些性能BUg？   你们测试哪些性能场景？为什么要这是他？
...
我觉得加班在程序员行业是比较普遍的，而且对于测试来说，游戏上线之前基本都比较忙，免不了加班的。

4.6、离职的原因是什么？

第一份工作：武汉零感网域，我进去的时候17个人，6开发，3测试，4产品，1运维，1大老板

3开发，2产品，1运维，1财务，1大老板，开发走了一半多，测试全走了。我的工作内容也变成了，开发加测试，所以我觉得继续在这家公司对我前途发展很不利，所以提出离职。

第二份工作：广州米茄，做游戏测试的，我主要考虑的是，工作地点（广州）和女朋友离地了，所以希望来这边工作。而且这也是一份不错的工作机会。
...
任务完成要求副本入口是50到60级，玩家主要等级充钱比较多，购买了很多升60级的材料，没办法进入这个副本，导致主线任务的死锁。



3《背包》的BUG

新项目《星陨》，测试背包模块的时候已经用例执行结束了，就随机测试了一下。然后筛选中有很多的选项，大概十几个选项，其中的一个选项分类，然后单独点击这个实现筛选，筛选不会有结果。给我吓了一跳。毕竟是个简单的点，差一点就测试漏了。
